// app/[locale]/auth/sign-in/page.tsx  (or wherever your route lives)
// ─────────────────────────────────────────────────────────────────
// Single-file refactor of: Logo · LocaleSwitcher · AuthHeader ·
// SecondaryButton · TextInput · PasswordInput · SignInClient · SignInForm
// ─────────────────────────────────────────────────────────────────
'use client';
...
function SignInForm() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      const errorMsg =
        msg === 'Refresh token not provided in the request body'
  ...
  }, [t, router, loginError, loginSuccess]);
      ...
      <div className="w-full max-w-[1100px] mx-auto">
        ...
        >
          ...
          <div className="relative hidden lg:block w-[48%] min-h-[520px]">
            ...
            {/* Gradient overlay — richer, brand-aligned */}
            <div
              aria-hidden="true"
            ...
            {/* Brand watermark */}
            <div className="absolute bottom-8 ltr:left-8 rtl:right-8 z-30">
              <span className="text-white/80 font-extrabold text-2xl tracking-tight drop-shadow-md">
                {/* Logo text rendered as watermark */}
              </span>
            </div>
          </div>
        </div>
